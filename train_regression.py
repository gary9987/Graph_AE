...
def main(arg):
    ...
    valid_set = DataLoader(data_set.train_data[arg.n_train:arg.n_train + arg.n_valid], batch_size=batch_size, shuffle=False)
    test_set = DataLoader(data_set.test_data, batch_size=batch_size, shuffle=False)
    ...
    train_rg(model, r_model, optimizer, device, train_set, valid_set, test_set, num_epoch)
...
if __name__ == "__main__":
    ...
    # for classifier
    parser.add_argument('--n_train', type=int, default=14000, help="number of samples for train set")
    parser.add_argument('--n_valid', type=int, default=1000, help="number of samples for valid set")
